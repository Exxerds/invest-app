...
|---|---|---|
| PrivateAlps VPS 30 (2 ядра / 3 ГБ / 30 ГБ) | БЭКЕНД (скрытый): приложение + база | есть |
| Njalla VPS | ПРОКСИ (публичный): достаточно VPS 15 (€15); заказчик дал ссылку на VPS 30 (€30) — тоже подойдёт с запасом | заказать: njal.la → Servers |
